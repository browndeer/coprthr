...
printf "if (clGetDeviceIDs(platforms[0],CL_DEVICE_TYPE_ACCELERATOR,0,0,&ndev)) \n";
...
printf "\n";
printf "if (clGetDeviceIDs(platforms[0],CL_DEVICE_TYPE_ACCELERATOR,ndev,devices,0)) \n";
printf "exit(__LINE__);\n";
printf "\n";

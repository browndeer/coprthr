...
size_t file_sz;
void* pfile;
__mapfile("test_block2_int.cl",file_sz,pfile);
...
cl_kernel krn;
int sum,sum_correct;
krn = clCreateKernel(prg,"test_block2_1_1_kern",&err);
if (err) exit(__LINE__);
...
krn = clCreateKernel(prg,"test_block2_1_2_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufb0)) exit(__LINE__);
...
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_2_1_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
...
if (clReleaseEvent(ev[1])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_1_3_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufb0)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufb1)) exit(__LINE__);
...
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_2_2_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufb0)) exit(__LINE__);
...
if (clReleaseEvent(ev[2])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_3_1_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
...
if (clReleaseEvent(ev[1])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_1_4_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufb0)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufb1)) exit(__LINE__);
...
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_2_3_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufb0)) exit(__LINE__);
...
if (clReleaseEvent(ev[3])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_3_2_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);
...
if (clReleaseEvent(ev[2])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_4_1_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);
...
if (clReleaseEvent(ev[1])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_1_5_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufb0)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufb1)) exit(__LINE__);
...
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_2_4_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufb0)) exit(__LINE__);
...
if (clReleaseEvent(ev[4])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_3_3_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);
...
if (clReleaseEvent(ev[3])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_4_2_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);
...
if (clReleaseEvent(ev[2])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_5_1_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);
...
if (clReleaseEvent(ev[1])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_1_6_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufb0)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufb1)) exit(__LINE__);
...
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_2_5_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufb0)) exit(__LINE__);
...
if (clReleaseEvent(ev[5])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_3_4_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);
...
if (clReleaseEvent(ev[4])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_4_3_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);
...
if (clReleaseEvent(ev[3])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_5_2_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);
...
if (clReleaseEvent(ev[2])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_6_1_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);
...
if (clReleaseEvent(ev[1])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_1_7_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufb0)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufb1)) exit(__LINE__);
...
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_2_6_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufb0)) exit(__LINE__);
...
if (clReleaseEvent(ev[6])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_3_5_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);
...
if (clReleaseEvent(ev[5])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_4_4_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);
...
if (clReleaseEvent(ev[4])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_5_3_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);
...
if (clReleaseEvent(ev[3])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_6_2_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);
...
if (clReleaseEvent(ev[2])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_7_1_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);
...
if (clReleaseEvent(ev[1])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_1_8_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufb0)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufb1)) exit(__LINE__);
...
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_2_7_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufb0)) exit(__LINE__);
...
if (clReleaseEvent(ev[7])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_3_6_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);
...
if (clReleaseEvent(ev[6])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_4_5_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);
...
if (clReleaseEvent(ev[5])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_5_4_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);
...
if (clReleaseEvent(ev[4])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_6_3_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);
...
if (clReleaseEvent(ev[3])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_7_2_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);
...
if (clReleaseEvent(ev[2])) exit(__LINE__);
if (clReleaseKernel(krn)) exit(__LINE__);
krn = clCreateKernel(prg,"test_block2_8_1_kern",&err);
if (err) exit(__LINE__);
if (clSetKernelArg(krn,0,sizeof(cl_mem),&bufa0)) exit(__LINE__);
if (clSetKernelArg(krn,1,sizeof(cl_mem),&bufa1)) exit(__LINE__);
if (clSetKernelArg(krn,2,sizeof(cl_mem),&bufa2)) exit(__LINE__);

...
if (err) exit(__LINE__);
float* aa0 = (float*)malloc(size*sizeof(int));
if (!aa0) exit(__LINE__);
float* bb0 = (float*)malloc(size*sizeof(int));
if (!bb0) exit(__LINE__);
float* aa1 = (float*)malloc(size*sizeof(int));
if (!aa1) exit(__LINE__);
float* bb1 = (float*)malloc(size*sizeof(int));
if (!bb1) exit(__LINE__);
float* aa2 = (float*)malloc(size*sizeof(int));
if (!aa2) exit(__LINE__);
float* bb2 = (float*)malloc(size*sizeof(int));
if (!bb2) exit(__LINE__);
float* aa3 = (float*)malloc(size*sizeof(int));
if (!aa3) exit(__LINE__);
float* bb3 = (float*)malloc(size*sizeof(int));
if (!bb3) exit(__LINE__);
float* aa4 = (float*)malloc(size*sizeof(int));
if (!aa4) exit(__LINE__);
float* bb4 = (float*)malloc(size*sizeof(int));
if (!bb4) exit(__LINE__);
float* aa5 = (float*)malloc(size*sizeof(int));
if (!aa5) exit(__LINE__);
float* bb5 = (float*)malloc(size*sizeof(int));
if (!bb5) exit(__LINE__);
float* aa6 = (float*)malloc(size*sizeof(int));
if (!aa6) exit(__LINE__);
float* bb6 = (float*)malloc(size*sizeof(int));
if (!bb6) exit(__LINE__);
float* aa7 = (float*)malloc(size*sizeof(int));
if (!aa7) exit(__LINE__);
float* bb7 = (float*)malloc(size*sizeof(int));

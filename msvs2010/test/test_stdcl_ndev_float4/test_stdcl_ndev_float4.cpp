...
int ndev = devnum + 1;
if (ndev > clgetndev(cp)) __exit(__LINE__);
size_t size4 = size/4;
size_t ns = ndev*size;
...
clarg_set_global(cp,krn,3,bb2[n]);
clarg_set_global(cp,krn,4,bb3[n]);
clarg_set_global(cp,krn,5,bb4[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,3,bb1[n]);
clarg_set_global(cp,krn,4,bb2[n]);
clarg_set_global(cp,krn,5,bb3[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,3,bb0[n]);
clarg_set_global(cp,krn,4,bb1[n]);
clarg_set_global(cp,krn,5,bb2[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,3,aa3[n]);
clarg_set_global(cp,krn,4,bb0[n]);
clarg_set_global(cp,krn,5,bb1[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,2,aa2[n]);
clarg_set_global(cp,krn,3,aa3[n]);
clarg_set_global(cp,krn,4,aa4[n]);
clarg_set_global(cp,krn,5,bb0[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,4,bb3[n]);
clarg_set_global(cp,krn,5,bb4[n]);
clarg_set_global(cp,krn,6,bb5[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,4,bb2[n]);
clarg_set_global(cp,krn,5,bb3[n]);
clarg_set_global(cp,krn,6,bb4[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,4,bb1[n]);
clarg_set_global(cp,krn,5,bb2[n]);
clarg_set_global(cp,krn,6,bb3[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,4,bb0[n]);
clarg_set_global(cp,krn,5,bb1[n]);
clarg_set_global(cp,krn,6,bb2[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,4,aa4[n]);
clarg_set_global(cp,krn,5,bb0[n]);
clarg_set_global(cp,krn,6,bb1[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,3,aa3[n]);
clarg_set_global(cp,krn,4,aa4[n]);
clarg_set_global(cp,krn,5,aa5[n]);
clarg_set_global(cp,krn,6,bb0[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,5,bb4[n]);
clarg_set_global(cp,krn,6,bb5[n]);
clarg_set_global(cp,krn,7,bb6[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,5,bb3[n]);
clarg_set_global(cp,krn,6,bb4[n]);
clarg_set_global(cp,krn,7,bb5[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,5,bb2[n]);
clarg_set_global(cp,krn,6,bb3[n]);
clarg_set_global(cp,krn,7,bb4[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,5,bb1[n]);
clarg_set_global(cp,krn,6,bb2[n]);
clarg_set_global(cp,krn,7,bb3[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,5,bb0[n]);
clarg_set_global(cp,krn,6,bb1[n]);
clarg_set_global(cp,krn,7,bb2[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,5,aa5[n]);
clarg_set_global(cp,krn,6,bb0[n]);
clarg_set_global(cp,krn,7,bb1[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,4,aa4[n]);
clarg_set_global(cp,krn,5,aa5[n]);
clarg_set_global(cp,krn,6,aa6[n]);
clarg_set_global(cp,krn,7,bb0[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,6,bb5[n]);
clarg_set_global(cp,krn,7,bb6[n]);
clarg_set_global(cp,krn,8,bb7[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,6,bb4[n]);
clarg_set_global(cp,krn,7,bb5[n]);
clarg_set_global(cp,krn,8,bb6[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,6,bb3[n]);
clarg_set_global(cp,krn,7,bb4[n]);
clarg_set_global(cp,krn,8,bb5[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,6,bb2[n]);
clarg_set_global(cp,krn,7,bb3[n]);
clarg_set_global(cp,krn,8,bb4[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,6,bb1[n]);
clarg_set_global(cp,krn,7,bb2[n]);
clarg_set_global(cp,krn,8,bb3[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,6,bb0[n]);
clarg_set_global(cp,krn,7,bb1[n]);
clarg_set_global(cp,krn,8,bb2[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,6,aa6[n]);
clarg_set_global(cp,krn,7,bb0[n]);
clarg_set_global(cp,krn,8,bb1[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {
...
clarg_set_global(cp,krn,5,aa5[n]);
clarg_set_global(cp,krn,6,aa6[n]);
clarg_set_global(cp,krn,7,aa7[n]);
clarg_set_global(cp,krn,8,bb0[n]);
if (!clfork(cp,n,krn,&ndr,CL_EVENT_NOWAIT))
__exit(__LINE__);
}
for(n=0;n<ndev;n++) {

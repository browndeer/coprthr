...
#define safe_div(a,b) ((b==0)? 0 : a/b)
	...
	if (!e32ser_engine_ready()) e32ser_engine_startup(0);
	...
	int err = e32ser_engine_klaunch(0,0,wp,argp);
...
{
	printcl( CL_DEBUG "marker: unsupported");
	return(0); 
}

...
#ifndef _e32pth_engine_blank_h
#define _e32pth_engine_blank_h
...
void* e32pth_engine_startup_blank( void* p );

int e32pth_engine_klaunch_blank( int engid_base, int ne, struct workp* wp, 
	struct cmdcall_arg* argp );

int e32pth_engine_ready_blank();

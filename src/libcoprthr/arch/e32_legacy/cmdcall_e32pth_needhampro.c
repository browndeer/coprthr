...
#define safe_div(a,b) ((b==0)? 0 : a/b)
	...
	if (!e32pth_engine_ready_needhampro()) {
		int err = e32pth_engine_startup_needhampro((void*)devid);
...
//	struct workp* wp = workp_alloc( 16 );
	...
	int err = e32pth_engine_klaunch_needhampro(0,0,wp,argp);
...
cmdcall_t cmdcall_e32pth_needhampro[] = {
	0,
	exec_ndrange_kernel,
	task,
	native_kernel,

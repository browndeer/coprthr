...
{
	printcl( CL_DEBUG "cmdcall_arm:ndrange_kernel");
...
{
	printcl( CL_WARNING "cmdcall_arm:task: unsupported");
	return(0); 
}
...
{
	printcl( CL_WARNING "cmdcall_arm:native_kernel: unsupported");
	return(0); 
}
...
{
	printcl( CL_DEBUG "cmdcall_arm:read_buffer");
...
{
	printcl( CL_DEBUG "cmdcall_arm:write_buffer");
...
{
	printcl( CL_DEBUG "cmdcall_arm:copy_buffer");
...
{
//	printcl( CL_WARNING "cmdcall_arm:read_image: unsupported");
//	return(0); 

	printcl( CL_DEBUG "cmdcall_arm:read_image");
...
{
//	printcl( CL_WARNING "cmdcall_arm:write_image: unsupported");
//	return(0); 

	printcl( CL_DEBUG "cmdcall_arm:write_image");
...
/*
	...
	printcl( CL_DEBUG "cmdcall_arm:write_image: XXX %p %p %d",dst+offset,src,len);

	if (dst+offset == src) return(0);
	else memcpy(dst+offset,src,len);

	size_t* sp = (size_t*)dst;
printcl( CL_DEBUG "cmdcall_arm:write_image: XXX %d %d %d",sp[0],sp[1],sp[16]);
*/
...
{
	printcl( CL_WARNING "cmdcall_arm:copy_image: unsupported");
	return(0); 
}
...
{
	printcl( CL_WARNING "cmdcall_arm:copy_image_to_buffer: unsupported");
	return(0); 
}
...
{
	printcl( CL_WARNING "cmdcall_arm:copy_buffer_to_image: unsupported");
	return(0); 
}
...
{
	printcl( CL_WARNING "cmdcall_arm:map_buffer: unsupported");
	return(0); 
}
...
{
	printcl( CL_WARNING "cmdcall_arm:map_image: unsupported");
	return(0); 
}
...
{
	printcl( CL_WARNING "cmdcall_arm:unmap_mem_object: unsupported");
	return(0); 
}
...
{
	printcl( CL_DEBUG "cmdcall_arm:marker");
	return(0); 
}
...
{
	printcl( CL_WARNING "cmdcall_arm:acquire_gl_objects: unsupported");
	return(0); 
}
